...
public class SnowBallFactory implements RoleFactory {
  ...
  /*Halt*/		{ new ImageSequence( "pics/AI/SnowBall/Walk/East","png",1) ,
					new ImageSequence( "pics/AI/SnowBall/Walk/East","png",1) ,
					new ImageSequence( "pics/AI/SnowBall/Walk/West","png",1) ,
					new ImageSequence( "pics/AI/SnowBall/Walk/West","png",1)} ,
  /*Walk*/		{ new ImageSequence( "pics/AI/SnowBall/Walk/East","png",1) ,
						new ImageSequence( "pics/AI/SnowBall/Walk/East","png",1) ,
						new ImageSequence( "pics/AI/SnowBall/Walk/West","png",1) ,
						new ImageSequence( "pics/AI/SnowBall/Walk/West","png",1)}
					};
